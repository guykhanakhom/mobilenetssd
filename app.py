...
lineaccesstoken    =    'UL01KQSv9p5VYbdINqvNR94Cu9o2T6XPecaW8f3zPg3vQOg9KFbGvfBu+2G9A0msGXLCNzqlgLNVBkxsXQpsXkvQt/1R4/vBG6LK3TUw01yU46yTodeVX0JD3negaG5Wqy0mPW04237negvH1VDgggdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี"): 
            ...
            replyObj = TextSendMessage(text="ยังข่าบ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "หิวป่าว"):
            replyObj = TextSendMessage(text="ไม่หิวอ่ะ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "ไปเที่ยวป่าว"):
            replyObj = TextSendMessage(text="ไม่ไป")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloudgoogle.com/v1/integrations/line/webhook/25e9d337-c228-4ed8-b5bc-3198b035e4a0"
